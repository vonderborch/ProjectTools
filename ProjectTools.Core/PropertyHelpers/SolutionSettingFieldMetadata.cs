...
public class SolutionSettingFieldMetadata : TemplateFieldMetadata
{
    ...
    public SolutionSettingFieldMetadata(string displayName, string templateSettingFieldName, PropertyType type,
        int order, object? defaultValue = null, string? requiredFieldName = null, object? requiredFieldValue = null,
        object? disallowedFieldValue = null) : base(displayName, type, order, requiredFieldName, requiredFieldValue,
