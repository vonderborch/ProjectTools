...
public class TemplateFieldMetadata : Attribute
{
    ...
    /// The value of the required field that causes this field to be not shown to a user.
    /// </param>
    public TemplateFieldMetadata(string displayName, PropertyType type, int order, string? requiredFieldName = null,
        object? requiredFieldValue = null, object? disallowedFieldValue = null)
    {
