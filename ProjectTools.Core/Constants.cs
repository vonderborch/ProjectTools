...
public class Constants
{
    ...
    /// </summary>
    public const string LICENSE_EXPRESSIONS =
    ...
    /// The special text
    /// </summary>
    public static readonly string[] SPECIAL_TEXT =
        { "<CurrentUserName>", "<CurrentDir>", "<SolutionName>", "<ProjectFullName>" };
    ...
    /// </summary>
    public static readonly string TemplatesProjectConfigurationDirectory =
        Path.Combine(CoreDirectory, "ProjectConfiguration");

    /// <summary>
    /// The working file for storing a project's configuration
    /// </summary>
    public static readonly string TemplatesProjectConfigurationFile =
        Path.Combine(CoreDirectory, "project_configuration.json");
