...
public readonly struct TemplateUpdateResult
{
    ...
    public TemplateUpdateResult(int totalRemoteTemplatesProcessed, List<TemplateGitMetadata> newTemplates,
        List<TemplateGitMetadata> updateableTemplates, List<string> orphanedTemplates)
    {
    ...
    public ulong NewTemplateSize
    {
        ...
        {
            var totalSize = 0UL;
            foreach (var template in NewTemplates) totalSize += (ulong)template.Size;
            return totalSize;
        }
    }
    ...
    public ulong UpdateableTemplateSize
    {
        ...
        {
            var totalSize = 0UL;
            foreach (var template in UpdateableTemplates) totalSize += (ulong)template.Size;
            return totalSize;
        }
    }
}