...
namespace ProjectTools.Core.Templating.Common
{
    ...
    public class TemplateSettings
    {
        ...
        /// </summary>
        [SettingMetaAttribute("Cleanup Files And Directories (comma-separated)", SettingType.StringListComma)]
        ...
        /// </summary>
        [SettingMetaAttribute("Commands (semi-colan-separated)", SettingType.StringListSemiColan)]
        public List<string> Commands = [];

        /// <summary>
        /// The default author for a new solution using this template
        /// </summary>
        [SettingMetaAttribute("Default Author", SettingType.String)]
        public string DefaultAuthor = string.Empty;

        /// <summary>
        /// The default description for a new solution using this template
        /// </summary>
        [SettingMetaAttribute("Default Description", SettingType.String)]
        ...
        /// is ignored.
        /// </summary>
        [SettingMetaAttribute("Default Solution Name", SettingType.String)]
        public string DefaultSolutionName = string.Empty;

        /// <summary>
        /// The default solution name format for a new solution using this template
        /// </summary>
        [SettingMetaAttribute("Default Solution Name Format", SettingType.String)]
        public string DefaultSolutionNameFormat = string.Empty;

        /// <summary>
        /// The directories excluded in prepare
        /// </summary>
        [SettingMetaAttribute("Prepare-excluded Directories (comma-separated)", SettingType.StringListComma)]
        ...
        /// </summary>
        [SettingMetaAttribute("Instructions (semi-colan-separated)", SettingType.StringListSemiColan)]
        ...
        /// this template
        /// </summary>
        [SettingMetaAttribute("Rename-only Files and Directories (comma-separated)", SettingType.StringListComma)]
        ...
        /// </summary>
        [SettingMetaAttribute("Replacement Text (Format: key: value, key: value, etc.)", SettingType.TupleStringString)]
        public List<Tuple<string, string>> ReplacementText = [];
    }
}
