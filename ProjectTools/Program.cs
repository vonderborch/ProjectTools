...
internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        // process all commands in grouping iteratively
            ...
            ProcessTestArgument(testCommand.Item1,
                exampleCommands.PossibleCommands[testCommand.Item1][testCommand.Item2]);
        else
    ...
    private static void ProcessArguments(string[] args)
    {
        ...
        var parseResults =
            Parser.Default
                .ParseArguments<PrepareTemplate, GenerateProject, ListTemplates, UpdateTemplates, Configure, ReportIssue
                    , MakeSuggestion>(args);
