...
public class GenerateProject : AbstractOption
{
    ...
    {
        var contents = JsonHelpers.SerializeToString(SlugHelpers.GetSlugValues(slugs, false));
    ...
    public override string Execute()
    {
        ...
        if (this.WhatIf)
        {
            return "What-if Mode Enabled, no project generated!";
        }
    ...
    private List<Slug> GetUserInputForSlugs(string projectConfigFile, List<Slug> slugs)
    {
        ...
        {
            slugs = SlugHelpers.GetSlugsFromProjectConfigFile(projectConfigFile, slugs);
        }
    ...
    private Template UpdateTemplateWithUserInput(string projectConfigFile, Template template)
    {
        ...
        SlugHelpers.SaveSlugsToProjectConfigFile(projectConfigFile, inputNeededSlugs);
        SlugHelpers.SaveSlugsToProjectConfigFile(backupConfigFile, inputNeededSlugs);
